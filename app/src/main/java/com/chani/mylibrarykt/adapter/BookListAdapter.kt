...
class BookListAdapter : PagingDataAdapter<Book, BookListAdapter.BookListHolder>(BooksComparator()) {
    ...
    override fun onBindViewHolder(listHolder: BookListHolder, position: Int) {
        getItem(position)?.let { listHolder.bind(it) }
    }
